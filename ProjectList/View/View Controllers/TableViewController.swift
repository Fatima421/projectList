...
class TableViewController: UITableViewController {
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.LabelName.text = "\(viewModel.getPersonName(indexPath.row)) \(viewModel.getPersonSurname(indexPath.row))"
        cell.LabelCargo.text = viewModel.getPersonCharge(indexPath.row)
